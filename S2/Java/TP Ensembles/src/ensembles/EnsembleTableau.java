...
public class EnsembleTableau<E> extends EnsembleGenerique<E>
{
	...
	{
		/*
		 * TODO Remplacer par l'initialisation du tableau
		 */	
	...
	{
		/*
		 * TODO Remplacer par l'initialisation du tableau, puis l'ajout (au
		 * sens des ensembles) des éléments de "elements"
		 */
		tableau = new Tableau<E>();
	 ...
	 * Ce qui revient dans le cas présent à ajouter un élément au tableau si
	...
	public Ensemble<E> union(Ensemble<E> ensemble)
	{
		/*
		 * TODO Remplacer par :
		 * 	- la création d'un nouvel ensemble résultat
		 * 	- l'union de this et ensemble dans résultat en réutilisant ce que
		 * 	  l'on a déjà écrit
	...
	public Ensemble<E> intersection(Ensemble<E> ensemble)
	{
		 ...
		 * TODO Remplacer par :
		 * 	- la création d'un nouvel ensemble résultat
		 * 	- l'intersection de this et ensemble dans résultat en réutilisant
	...
	public Ensemble<E> complement(Ensemble<E> ensemble)
	{
		 ...
		 * TODO Remplacer par :
		 * 	- la création d'un nouvel ensemble résultat
		 * 	- le complément de this et ensemble dans résultat en réutilisant
		 * 	  ce que l'on a déjà écrit
		 * 	- le renvoi de résultat
		 */
		return null;
