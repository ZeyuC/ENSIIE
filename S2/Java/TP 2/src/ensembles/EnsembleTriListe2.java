...
/**
 * Ensemble trié utilisant une {@link EnsembleListe}
 *
 * 
 */
public class EnsembleTriListe2<E extends Comparable<E>> extends
	EnsembleTriGenerique<E> implements EnsembleTri<E> {
	/**
	 * Constructeur par défaut d'un ensemble trié utilisant un {@link EnsembleListe}
	 */
	...
	protected boolean insererAuRang(E element, int rang) {
		...
		((EnsembleListe<E>) ensemble).liste.insert(element, rang);
		return true;
	}
}
