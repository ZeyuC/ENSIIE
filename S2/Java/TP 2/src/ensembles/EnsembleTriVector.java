...
public class EnsembleTriVector<E extends Comparable<E>> 
            extends  EnsembleVector<E> implements EnsembleTri<E> {

	/**
	 * Constructeur par défaut d'un ensemble trié utilisant un {@link Vector}
	 */
	 ...
	 *         n'est pas inséré).
	 * @see ensembles.EnsembleVector#ajout(java.lang.Object)
	...
	public boolean ajout(E element) {
		...
		{
			vector.insertElementAt(element, rang(element));
			return true;
		}
	} 
	...
	{		
		...
		{
			Ensemble<?> obj = (Ensemble<?>)o;
			if(obj.typeElements()==this.typeElements())
			{
				@SuppressWarnings("unchecked")
				Ensemble<E> e= (Ensemble<E>)obj;
				Iterator<E> iterator = iterator();
				Iterator<E> iterator2 = e.iterator();
