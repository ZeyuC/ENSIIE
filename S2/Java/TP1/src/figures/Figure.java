...
public interface Figure extends Cloneable {
	...
	/** Méthode abstraite pour le déplacement de la figure
	 * @param dx déplacement selon l'axe des X
	 * @param dy déplacement selon l'axe des Y
	 * @return renvoie une référence vers la figure
	...
	/** Distance entre les centres de la figure courante et d'une figure passée en argument
