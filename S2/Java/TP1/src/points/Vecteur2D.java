...
public class Vecteur2D extends Point2D {
	...
	/** Constructeur valué d'un vecteur 2D à partir d'un point
	...
	/** Constructeur valué d'un vecteur 2D à partir de coordonnées
	...
	/** Constructeur valué d'un vecteur 2D à partir de deux points
