...
public class ListeTest
{
	 ...
	 * homogÃ¨ne : donc n'importe quel type ferait l'affaire.
	 */
	...
	/**
	 * Nettoyage aprÃ¨s l'ensemble des tests
	 * @throws java.lang.Exception
	 */
	@AfterClass
	...
	public final void testAdd()
	{
		...
		for (int i=1; i < elements.length; i++)
		{
			 ...
			 * next sur le même itérateur génÃ¨rera un NoSuchelementException.
...
//	}
	...
	public final void testEqualsObject() {
		...
		// Inégalité sur liste à contenu dans une autre ordre
		liste2.clear();
		for(String elt : elements)
			liste2.insert(elt);
		result = liste.equals(liste2);
